...
def _env_int_setting(name: str, default: int, *, minimum: int = 1) -> int:
    try:
...
PARTICIPANT_ONLINE_SECONDS = _env_int_setting("PICOIN_PARTICIPANT_ONLINE_SECONDS", 300, minimum=30)
PARTICIPANT_OFFLINE_SECONDS = max(
    PARTICIPANT_ONLINE_SECONDS + 1,
    _env_int_setting("PICOIN_PARTICIPANT_OFFLINE_SECONDS", 900, minimum=PARTICIPANT_ONLINE_SECONDS + 1),
)
VALIDATOR_SYNC_LAG_BLOCKS = 3
VALIDATOR_OUT_OF_SYNC_SECONDS = _env_int_setting("PICOIN_VALIDATOR_OUT_OF_SYNC_SECONDS", 180, minimum=1)
