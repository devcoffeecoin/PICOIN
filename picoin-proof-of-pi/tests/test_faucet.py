...
def test_local_faucet_credits_registered_miner_from_genesis(tmp_path, monkeypatch) -> None:
    ...
    result = request_faucet(miner["miner_id"], "miner", 10.5)
    ...
    assert miner_balance["balance"] == 10.5
    assert genesis_balance["balance"] == GENESIS_SUPPLY - 10.5
