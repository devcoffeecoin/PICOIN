...
const VALIDATOR_SUBMIT_TIMEOUT_SECONDS = "180";
...
const DESKTOP_VALIDATOR_VERSION = "0.1.15";
...
function buildEnv(config: ValidatorConfig): NodeJS.ProcessEnv {
  ...
  return {
    ...
    PICOIN_VALIDATOR_SUBMIT_TIMEOUT_SECONDS: VALIDATOR_SUBMIT_TIMEOUT_SECONDS,
...
export async function startValidator(config: ValidatorConfig) {
  ...
  child = spawnPython(
    ...
    [
      ...
      "--submit-timeout",
      VALIDATOR_SUBMIT_TIMEOUT_SECONDS,
    ],
    env,
    (code) => {
