const TARGET = process.env.PICOIN_VALIDATOR_API_URL || "https://api.picoin.science";
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    res.status(502).json({ detail: "Picoin validator API unavailable", error: error.message });
  } finally {
